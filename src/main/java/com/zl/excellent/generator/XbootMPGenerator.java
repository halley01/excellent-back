package com.zl.excellent.generator;

import com.zl.excellent.generator.bean.Entity;
...
import static com.zl.excellent.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.exrick.xboot.modules.base.your.mapper";
